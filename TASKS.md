...
- [DONE] Implement directory-level cross-tool replacement so `skul use` can replace one tool's managed files with another tool's bundle in the same worktree.
